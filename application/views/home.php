...
<div class="wrapper">
 ...
 <!-- Them menu login sidebar,Su dung page login,tao table ,tao mysql database gmts,tao table account (id int autoincrement,username nvarchar(50),password nvarchar(50),email nvarchar(50),displayname nvarchar(100)),add 1 dong du lieu-->
